...
*/
            bounds = new Rectangle(rect.Left + 270, rect.Top+200, rect.Right - rect.Left, rect.Bottom - 220); //, rect.Right + rect.Left);
            //MessageBox.Show(rect.Left.ToString(), rect.Top.ToString(), rect.);
